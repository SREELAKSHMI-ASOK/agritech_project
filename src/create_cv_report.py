...
def main():
    print("--- Generating cv_results.md Report ---")
    
    # Define the file path matching your folder setup
    ...
    # Complete markdown text content
    markdown_content = """# Cross-Validation & Overfitting Analysis
...
"""
    ...
    # Write contents directly to the markdown target file
    with open(report_path, "w", encoding="utf-8") as f:
        f.write(markdown_content)
        
    print(f"Success! Report beautifully created at: {report_path}")
